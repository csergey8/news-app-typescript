...
export const marksAsRead = (id: string): ArticleActionType => {
    return {
        type: MARK_AS_READ,
        id
    }
...
export const rateArticle = (id: string, rating: number): ArticleActionType => {
    return {
        type: RATE_ARTICLE,
        id,
        rating
...
interface NewsActionType extends ActionTypeBase {
    id?: string;
    article?: Article;
}
